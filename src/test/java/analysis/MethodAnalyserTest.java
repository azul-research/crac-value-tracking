...
public class MethodAnalyserTest {
    ...
    public void analysisWithIfTest() {
        ...
        Entity[] expected = new Entity[3];
        expected[0] = new RootDerivative("args");
        expected[1] = new PhiDerivative(0, new NonDerivativeEntity(6), new StraightDerivative(9, expected[0]));
    ...
    public void analysisWithIfsAndWhiles() {
        ...
        expected[2] = new PhiDerivative(0, new NonDerivativeEntity(6), new StraightDerivative(12, expected[0]), new StraightDerivative(15, expected[3]));
