...
This is a tool, that allows you to identify “unsafe” sections of code 
(those that depend on the input data of the program) and “safe” sections of 
code (those that do not depend on the input data).
